...
// import { Node } from "react-icons/go";
...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="p-8  h-full relative flex items-center justify-center">
      <div className="flex flex-wrap flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="circle-3">
          <FaNodeJs className="h-8 w-8 dark:text-white" />
        </Container>
        ...
        <Container className="h-8 w-8 circle-5">
        ...
        </Container><Container className="h-8 w-8 circle-5">
          <GeminiLogo className="h-4 w-4 " />
        </Container><Container className="h-8 w-8 circle-5">
          <GeminiLogo className="h-4 w-4 " />
        </Container> */}
         <Container className="circle-3">
          <FaNodeJs className="h-8 w-8 dark:text-white" />
        </Container><Container className="circle-3">
          <FaNodeJs className="h-8 w-8 dark:text-white" />
        </Container><Container className="circle-3">
          <FaNodeJs className="h-8 w-8 dark:text-white" />
        </Container><Container className="circle-3">
...
export const FaNodeJss = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      width="28"
